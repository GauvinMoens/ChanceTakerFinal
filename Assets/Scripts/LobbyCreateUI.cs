...
public class LobbyCreateUI : MonoBehaviour {
    ...
    private void Awake() {
        ...
        gameModeButton.onClick.AddListener(() => {
            switch (gameMode) {
                default:
                case LobbyManager.GameMode.Standart:
                    gameMode = LobbyManager.GameMode.Standart1;
                    break;
                case LobbyManager.GameMode.Standart1:
                    gameMode = LobbyManager.GameMode.Standart;
                    break;
            }
            UpdateText();
        });
